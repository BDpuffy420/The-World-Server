...
/mob/living/carbon/human/interactive
	...
	var/smartness = 50
	var/attitude = 50
	var/slyness = 0 //Too much stool theft
	var/graytide = 0
	...
	if((TARGET && (TARGET in view(1))) || timeout >= 2)
		if((TARGET in view(1,src)))//this is a bit redundant but it saves two if blocks
			...
			if(istype(TARGET, /obj/machinery/door))
				...
				if(D.check_access(MYID) && !istype(D,/obj/machinery/door/blast))
					D.open()
					sleep(15)
	...
	for(var/dir in cardinal)
		...
		if(T)
			for(var/obj/machinery/door/D in T.contents)
				if(D.check_access(MYID) && !istype(D,/obj/machinery/door/blast) && D.density)
...
/mob/living/carbon/human/interactive/friendly
	New()
		...
		..()
/mob/living/carbon/human/interactive/dead
/mob/living/carbon/human/interactive/dead/New()
  ..()
  stat = DEAD
  dir = pick(1,2,4,8)

/mob/living/carbon/human/interactive/dead/gore

/mob/living/carbon/human/interactive/dead/gore/New()
  ..()
  apply_damages(150)       //apply 150 brute damage

/mob/living/carbon/human/interactive/dead/burn

/mob/living/carbon/human/interactive/dead/burn/New()
  ..()
  apply_damages(0,300)       //apply 300 burn damage
