...
/obj/machinery/door/airlock/steeldoor
	name = "Steel Door"
	icon = 'icons/obj/doors/doorsteel.dmi'
	assembly_type = /obj/structure/door_assembly/door_assembly_com

/obj/machinery/door/airlock/glasslide
	name = "Sliding Glass Door"
	icon = 'icons/obj/doors/doorglasslide.dmi'
	assembly_type = /obj/structure/door_assembly/door_assembly_com
...
/obj/machinery/door/airlock/woodframe
	name = "Wooden Frame Door"
	icon = 'icons/obj/doors/woodframe.dmi'
	assembly_type = /obj/structure/door_assembly/door_assembly_com


/obj/machinery/door/airlock/woodglass
	name = "Wood-Framed Glass Door"
	icon = 'icons/obj/doors/grassframe.dmi'
	assembly_type = /obj/structure/door_assembly/door_assembly_com
	hitsound = 'sound/effects/Glasshit.ogg'
	maxhealth = 300
	opacity = 0
...
/obj/machinery/door/airlock/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
	if (src.isElectrified())
		if (istype(mover, /obj/item))
			...
			if (i.materials && i.materials[MAT_METAL])
