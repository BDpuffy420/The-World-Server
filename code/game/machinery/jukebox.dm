...
/obj/machinery/media/jukebox/
	...
	var/list/datum/track/tracks = list(
		...
		new/datum/track("Jazz Vibe", 'sound/music/disco/jazzvibe.wav'),
		new/datum/track("Starman", 'sound/music/disco/starman.ogg'),
		new/datum/track("SS13 Funk", 'sound/music/disco/SS13funk.ogg'),
...
/obj/machinery/media/jukebox/ui_interact(mob/user, ui_key = "jukebox", var/datum/nanoui/ui = null, var/force_open = 1)
	var/title = "RetroBox - Terra Style"
	var/data[0]
