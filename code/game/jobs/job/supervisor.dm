...
/datum/job/captain
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "Nanotrasen officials and the president"
	...
	equip(var/mob/living/carbon/human/H)
		...
		var/obj/item/clothing/under/U = new /obj/item/clothing/under/rank/mayor(H)
		...
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/tie/sash(H.back), slot_in_backpack)

		var/sound/announce_sound = (ticker.current_state <= GAME_STATE_SETTING_UP)? null : sound('sound/misc/boatswain.ogg', volume=20)
		captain_announcement.Announce("Citizens! Mayor [H.real_name] has arrived!", new_sound=announce_sound)
...
/datum/job/hop
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			...
			if(4) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(H), slot_back)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H.back), slot_in_backpack)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/head_of_personnel_whimsy(H), slot_w_uniform)
...
/datum/job/judge
	...
	total_positions = 2
	spawn_positions = 2
	supervisors = "the mayor, law, and government"
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			...
			if(3) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel_norm(H), slot_back)
			if(4) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(H), slot_back)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/judge/black(H), slot_w_uniform)
...
/datum/job/lawyer
	...
	total_positions = 2
	spawn_positions = 2
	supervisors = "the city supervisor and judge"
	selection_color = "#dddddd"
	alt_titles = list("Defense Attorney","Prosecutor")
